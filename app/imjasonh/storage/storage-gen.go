...
func (c *BucketAccessControlsDeleteCall) Do() error {
	...
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/acl/{entity}")
...
func (c *BucketAccessControlsInsertCall) Do() (*BucketAccessControl, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.bucketaccesscontrol)
	if err != nil {
		return nil, err
	}
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/acl")
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
	urls += "?" + params.Encode()
...
func (c *BucketsDeleteCall) Do() error {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}")
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("DELETE", urls, body)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
...
func (c *BucketsInsertCall) Do() (*Bucket, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.bucket)
	if err != nil {
		return nil, err
	}
	ctype := "application/json"
	...
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b")
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header.Set("Content-Type", ctype)
	req.Header.Set("User-Agent", "google-api-go-client/0.5")
...
func (c *BucketsPatchCall) Do() (*Bucket, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.bucket2)
	if err != nil {
		return nil, err
	}
	ctype := "application/json"
...
func (c *ObjectAccessControlsDeleteCall) Do() error {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/o/{object}/acl/{entity}")
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
...
func (c *ObjectAccessControlsInsertCall) Do() (*ObjectAccessControl, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.objectaccesscontrol)
	if err != nil {
		return nil, err
	}
	ctype := "application/json"
	params := make(url.Values)
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/o/{object}/acl")
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
	urls = strings.Replace(urls, "{object}", cleanPathString(c.object), 1)
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("POST", urls, body)
...
func (c *ObjectsDeleteCall) Do() error {
	...
	params := make(url.Values)
	params.Set("alt", "json")
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/o/{object}")
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
	urls = strings.Replace(urls, "{object}", cleanPathString(c.object), 1)
	urls += "?" + params.Encode()
	req, _ := http.NewRequest("DELETE", urls, body)
...
func (c *ObjectsInsertCall) Do() (*Object, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.object)
	if err != nil {
		return nil, err
	}
	ctype := "application/json"
	...
	urls := ResolveRelative("https://www.googleapis.com/storage/v1beta1/", "b/{bucket}/o")
	if c.media_ != nil {
	...
	urls = strings.Replace(urls, "{bucket}", cleanPathString(c.bucket), 1)
	urls += "?" + params.Encode()
	contentLength_, hasMedia_ := ConditionallyIncludeMedia(c.media_, &body, &ctype)
	req, _ := http.NewRequest("POST", urls, body)
	if hasMedia_ {
...
func (c *ObjectsPatchCall) Do() (*Object, error) {
	var body io.Reader = nil
	body, err := WithoutDataWrapper.JSONReader(c.object2)
	if err != nil {
		return nil, err
	}
	ctype := "application/json"
